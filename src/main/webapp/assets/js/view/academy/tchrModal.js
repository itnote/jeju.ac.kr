...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: "userCd", label: '아이디', width: 130, align: "left"},
                {key: "userNm", label: '강사명', width: 120, align: "left"},
                {key: "email", label: '이메일', width: 160, align: "left"},
                {key: "hpNo", label: '전화번호', width: 120, align: "center"}
            ],
            body: {
                onClick: function () {
