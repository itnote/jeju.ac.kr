    ...
    FORM_CLEAR: function (caller, act, data) {
        axDialog.confirm({
            ...
            if (this.key == "ok") {
                ...
                caller.gridView02.target.setValue(0,"hasYn","Y");
            }
        });
    },
...
fnObj.searchView = axboot.viewExtend(axboot.searchView, {
    initView: function () {
        ...
        this.filter = $("#filter");
        this.schMenuGrpCd = $("#schMenuGrpCd");
    },
    getData: function () {
        return {
            ...
            schMenuGrpCd : this.schMenuGrpCd.val()
        }
    }
});
...
fnObj.formView01 = axboot.viewExtend(axboot.formView, {
    ...
    initView: function () {
        ...
        axboot.buttonClick(this, "data-form-view-01-btn", {
            ...
            "resetPw": function () {
                ACTIONS.dispatch(ACTIONS.RESET_PASSWORD);
            }
        });
