        ...
        *         return marker;
        ...
        return function () {
            ...
            var printDay = function printDay(nowDate) {
                ...
                this.setMarker(cfg.marker, true);
                ...
                setTimeout(function () {
                    if (cfg.mode === "day" || cfg.mode === "d") {
                        for (var k in this.markerMap) {
                            ...
                            if (this.markerMap[k].label) {
                                this.$["body"].find('[data-calendar-item-date="' + k + '"]').find(".addon-footer").html(this.markerMap[k].label);
                            }
                            if (this.markerMap[k].header) {
                                this.$["body"].find('[data-calendar-item-date="' + k + '"]').find(".addon-header").html(this.markerMap[k].header);
                            }
                        }
                    }
                }.bind(this));
                ...
                setTimeout(function () {
                    if (cfg.mode === "day" || cfg.mode === "d") {
                        for (var k in this.periodMap) {
                            ...
                            if (this.periodMap[k].header) {
                                this.$["body"].find('[data-calendar-item-date="' + k + '"]').find(".addon-header").html(this.periodMap[k].header);
                            }
            ...
            var clearPeriodMap = function clearPeriodMap() {
                if (cfg.mode === "day" || cfg.mode === "d") {
                    for (var k in this.periodMap) {
                        ...
                        this.$["body"].find('[data-calendar-item-date="' + k + '"]').find(".addon-header").empty();
