...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/_samples/test.js?ver=5' />"></script>
    </jsp:attribute>
    <jsp:body>
                    ...
                    <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                        <ax:tr labelWidth="120px">
                            <ax:td label="ax.admin.user.name" width="300px">
                                <input type="text" name="userNm" data-ax-path="userNm" maxlength="15" title="이름" class="av-required form-control W120" value=""  data-ax-validate="required"/>
                            </ax:td>
                        ...
                        <ax:tr labelWidth="120px">
                            <ax:td label="ax.admin.user.password" width="300px">
                                <input type="password" name="userPs" data-ax-path="userPs" maxlength="128" class="form-control W120" value="" readonly="readonly" title="비밀번호" />
                            </ax:td>
                            <ax:td label="ax.admin.user.password.confirm" width="460px">
                                <input type="password" name="userPs_chk" data-ax-path="userPs_chk" maxlength="128" class="form-control inline-block W120" value="" readonly="readonly" title="비밀번호"/>
                                &nbsp;
                        ...
                        <ax:tr labelWidth="120px">
                            <ax:td label="모달" width="100%">
                                <div class="form-inline">
                                    <div class="form-group">
                                        <input type="text" data-ax-path="modalCd" class="form-control inline-block W60" readonly="readonly" />
                                        <input type="text" data-ax-path="modalNm" class="form-control inline-block W150" />
                                        <button type="button" class="btn btn-primary" data-form-view-01-btn="modal1">
