...
<ax:layout name="modal">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/academy/tchrModal.js?v=211' />"></script>
    </jsp:attribute>
                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <ax:td label='ax.admin.sample.search.condition' width="300px">
                            <input type="text" class="form-control" data-ax-path="userNm" id="userNm"/>
                        </ax:td>
                    </ax:tr>
                </ax:tbl>
            </ax:form>
