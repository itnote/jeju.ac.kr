...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/axboot/system/system-auth-user.js?v=2' />"></script>
    </jsp:attribute>
    <jsp:body>
                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        ...
                        <ax:td label="메뉴그룹" width="300px">
                            <ax:common-code groupCd="MENU_GROUP" dataPath="schMenuGrpCd" emptyText="전체" id="schMenuGrpCd"/>
                        </ax:td>
                    </ax:tr>
                </ax:tbl>
            </ax:form>
                    ...
                    <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                        <ax:tr labelWidth="120px">
                            <ax:td label="ax.admin.user.name" width="300px">
                                <input type="text" name="userNm" data-ax-path="userNm" maxlength="15" title="사용자명" class="av-required form-control W120" value="" data-ax-validate="required"/>
                            </ax:td>
                            <ax:td label="ax.admin.user.id" width="220px">
                                <input type="text" name="userCd" data-ax-path="userCd" maxlength="100" title="아이디" class="av-required form-control W150" value="" data-ax-validate="required"/>
                            </ax:td>
                        </ax:tr>
                        <%--<ax:tr labelWidth="120px">
                            <ax:td label="ax.admin.user.password" width="300px">
                                <input type="password" name="userPs" data-ax-path="userPs" maxlength="128" class="form-control W120" value="" readonly="readonly" title="비밀번호" data-ax-validate="required"/>
                            </ax:td>
                            <ax:td label="ax.admin.user.password.confirm" width="460px">
                                <input type="password" name="userPs_chk" data-ax-path="userPs_chk" maxlength="128" class="form-control inline-block W120" value="" readonly="readonly" title="비밀번호" data-ax-validate="required"/>
                                &nbsp;
                                <label id="wrap_pwCheck">
                        ...
                        <ax:tr labelWidth="120px">
                            ...
                            <ax:td label="비밀번호" width="300px">
                                <button type="button" class="btn btn-default" data-form-view-01-btn="resetPw" style="display: none;" id="resetPw">
                                    <i class="cqc-vpn_key"></i>
                                    비밀번호 초기화
                                </button>
                            </ax:td>
                        </ax:tr>
