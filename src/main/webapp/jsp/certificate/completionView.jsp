...
<ax:set key="function1Label" value='<i class="cqc-download"></i> 연수증명서'/>
<ax:set key="function2Label" value='<i class="cqc-download"></i> 수료증명서'/>
<ax:set key="function3Label" value='<i class="cqc-download"></i> 성적증명서'/>

<ax:layout name="base">
    <jsp:attribute name="script">
        <ax:script-lang key="ax.script" />
        <script type="text/javascript" src="<c:url value='/assets/js/view/certificate/completionView.js' />"></script>
